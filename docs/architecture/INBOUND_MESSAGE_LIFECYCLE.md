...
**Established:** 2026-08-25 — Updated 2026-08-27 (WILD-04R-F5.1)  
**Read alongside:**
...
> **CRITICAL:** This document describes what the code does **now**, after WILD-04R, WILD-04R-F1, WILD-04R-F2, WILD-04R-F3, WILD-04R-F5, and WILD-04R-F5.1. If code conflicts with this document, STOP and report it as an architecture defect.
